        ...
        <li class="nav-item dropdown" role="menu">\
            ...
            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">\
                <li class="dropdown-submenu">\
                  <a  class="dropdown-item rec-psi" tabindex="-1" href="./zivotinje/psi.html">Psi</a>\
                  <ul class="dropdown-menu">\
                    <li class="dropdown-item"><a tabindex="-1" href="./zivotinje/psi/labrador.html" class="rec-labrador">Labrador</a></li>\
                    <li class="dropdown-item"><a href="./zivotinje/psi/samojed.html" class="rec-samojed">Samojed</a></li>\
                    <li class="dropdown-item"><a href="./zivotinje/psi/pudlica.html" class="rec-pudlica">Pudlica</a></li>\
                  </ul>\
                </li>\
                <li class="dropdown-submenu">\
                ...
                <li class="dropdown-submenu">\
                    <a  class="dropdown-item rec-ptice" tabindex="-1" href="./zivotinje/ptice.html">Ptice</a>\
                    <ul class="dropdown-menu">\
                      <li class="dropdown-item"><a tabindex="-1" href="./zivotinje/ptice/tigrice.html" class="rec-tigrica">Tigrica</a></li>\
                      <li class="dropdown-item"><a href="./zivotinje/ptice/nimfa.html" class="rec-nimfa">Nimfa</a></li>\
                      <li class="dropdown-item"><a href="./zivotinje/ptice/kanarinac.html" class="rec-kanarinac">Kanarinac</a></li>\
                    </ul>\
                </li>\
              </ul>\
        </li>\
